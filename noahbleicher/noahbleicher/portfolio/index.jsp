...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->
	...
	<div class="container">
		<div class="starter-template">
					...
					<h2>Bitbucket repository to my full stack development experiences.</h2>
					...
					<a href="https://bitbucket.org/nbleicher/airlinesatisfaction/src/master/" target="_blank"><img src="img/model.png" alt="Model" width="700"></a>
					<h2>Bitbucket repository to my machine learning model for airline satisfaction</h2>
					...
					<a href="https://bitbucket.org/nbleicher/informationsystemservices/src/master/" target="_blank"><img src="img/bb.png" alt="iss" width="100"></a>
					<h2>Bitbucket repository to my experience in Information System Services.</h2>
					...
					<p> Developed and created a Minecraft server with the appropriate access features and usability tools that an admin and user should have. 
